...
select_class_name = ['Background', 'Cell']
...
def get_validation_augmentation():   
    ...
    test_transform = [
        album.PadIfNeeded(min_height=IMAGE_SIZE, min_width=IMAGE_SIZE, always_apply=True, border_mode=cv2.BORDER_CONSTANT, value=(0, 0, 0), p=1.0),
    ]
...
def main():
    ...
    if os.path.exists(RESULT_DIR+'best_model.pth'):
